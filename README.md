...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://VolodymyrKirichenko.github.io/react_todo-app-loading-todos/) and add it to the PR description.
